...
################################################################################################
# CODE DESCRIPTION
# 17_prob_ff_hydro_long_fc_pdt_year.py computes the training dataset (Point Data Table) for a specific year to 
# compute the long-range data-driven forecasts of areas at risk of flash floods.

# Usage: python3 17_prob_ff_hydro_long_fc_pdt_year.py 2024
...
dir_out = "data/processed/17_prob_ff_hydro_long_fc_pdt_year"
################################################################################################
