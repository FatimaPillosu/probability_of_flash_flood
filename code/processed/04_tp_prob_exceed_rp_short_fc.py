...
#########################################################################################
# CODE DESCRIPTION
# 04_tp_prob_exceed_rp_short_fc.py computes the probabilities of 24-hourly short-range rainfall (from 
# ERA5-ecPoint) of exceeding a considered list of return periods.

# Usage: python3 04_tp_prob_exceed_rp_short_fc.py 2024
...
dir_in_reanalysis = "data/raw/reanalysis/era5_ecpoint/tp_24h_short_fc"
dir_out = "data/processed/04_tp_prob_exceed_rp_short_fc"
#########################################################################################
