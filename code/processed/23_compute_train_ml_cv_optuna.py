...
##################################################################################################
# CODE DESCRIPTION
# 23_compute_train_ml_cv_optuna.py trains the considered machine learning models (i.e., decision trees and neural 
# networks) to forecast probabilities of flash flood. The training consideres stratified k-fold cross-validation and optuna 
# for hyperparameter tuning.
# Runtime: the code can tke up to 2 days.
...
file_in = "data/compute/21_combine_pdt/pdt_2001_2020.csv"
dir_out = "data/compute/23_train_ml_cv_optuna"
##################################################################################################
