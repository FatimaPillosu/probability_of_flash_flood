...
#################################################################
# CODE DESCRIPTION
# 13_plot_timeseries_counts_noaa_reports_ff.py plots the yearly timeseries of 
# the counts of flood reports in the NOAA database, comparing the counts of all 
# reports and only flash flood ones. 
# Runtime: negligible.
...
dir_in = "data/compute/12_extract_noaa_reports_ff"
dir_out = "data/plot/13_timeseries_counts_noaa_reports_ff"
#################################################################
