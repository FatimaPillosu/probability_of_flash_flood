...
#################################################################################################
# CODE DESCRIPTION
# 16_plot_doughnut_chart_point_ff_per_grid.py plots a doughnut chart of the distribution of the accumulated  
# point flash flood reports per grid-box in the north-west (NW), north-east(NE), south-west (SW) and south-east (SE) of 
# the US.
# Runtime: the script takes up to 5 minutes.
...
dir_in = "data/compute/15_grid_acc_reports_ff"
dir_out = "data/plot/16_doughnut_chart_point_ff_per_grid"
#################################################################################################
