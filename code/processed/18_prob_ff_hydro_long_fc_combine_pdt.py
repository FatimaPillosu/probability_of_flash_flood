...
#######################################################################
# CODE DESCRIPTION
# 18_prob_ff_hydro_long_fc_combine_pdt.py combines the point data tables (for 
# long-range forecasts) for single years to create the full required training dataset.

# Usage: python3 18_prob_ff_hydro_long_fc_combine_pdt.py
...
dir_in = "data/processed/17_prob_ff_hydro_long_fc_pdt_year"
dir_out = "data/processed/18_prob_ff_hydro_long_fc_combine_pdt"
#######################################################################
