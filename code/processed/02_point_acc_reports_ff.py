...
##################################################################################
# CODE DESCRIPTION
# 02_point_acc_reports_ff.py creates the point accumulated flash flood reports over the same 
# rainfall's 24-hourly accumulation periods.

# Usage: python3 02_point_acc_reports_ff.py
...
year_s = 1950
year_f = 2024
git_repo = "/ec/vol/ecpoint_dev/mofp/phd/probability_of_flash_floods"
file_in = "data/processed/01_extract_noaa_reports_ff/noaa_reports_ff.csv"
dir_out = "data/processed/02_point_acc_reports_ff"
##################################################################################
