...
############################################################################################################
# CODE DESCRIPTION
# 20_prob_ff_hydro_short_fc_compute_poff_sa.py computes the short-range forecasts for the Probability of Flash Floods (PoFF)
# for the sensitivity analysis. 

# Usage: python3 20_prob_ff_hydro_short_fc_compute_poff_sa.py
...
dir_in_model = "data/processed/19_prob_ff_hydro_short_fc_sensitivity_global/bce/auc/gradient_boosting_xgboost"
dir_out = "data/processed/20_prob_ff_hydro_short_fc_compute_poff_sa"
############################################################################################################
...
for sa_name in sa_name_list:
      ...
      print(f"Loading the data-driven model for sa: {sa_name}")
      file_in_model = f"{git_repo}/{dir_in_model}/{sa_name}" # future improvement: add the possibility to have the neural network
