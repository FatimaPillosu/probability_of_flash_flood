...
#####################################################################################
# CODE DESCRIPTION
# 11_plot_swvl_1m_perc.py plots the instantaneous percentage of ERA5's soil saturation (swvl) for the 
# top 1m level, at 00 UTC.
# Runtime: the code takes up to 30 minutes to run.
...
dir_in = "data/compute/10_swvl_1m_perc"
dir_out = "data/plot/11_swvl_1m_perc"
#####################################################################################
...
file_out = dir_out_temp + "/swvl_1m_perc_" + the_date.strftime("%Y%m%d") + "_" + the_date.strftime("%H")
