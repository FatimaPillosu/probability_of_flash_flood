...
##########################################################################################
# CODE DESCRIPTION
# 17_plot_map_rel_freq_point_ff_per_grid.py creates a map plot of the relative 
# frequency of point accumulated flash flood reports in each grid-box of the domain.
# Runtime: the code takes up to 3 minutes.
...
dir_out = "data/plot/17_plot_map_rel_freq_point_ff_per_grid"
##########################################################################################
