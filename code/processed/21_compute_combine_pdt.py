...
#####################################################################################
# CODE DESCRIPTION
# 21_compute_combine_pdt.py combines the point data tables (pdt) for the years considered during 
# training to create the full required training dataset.
# Runtime: the code takes up to 5 minutes.
...
dir_in = "data/compute/20_pdt_year"
dir_out = "data/compute/21_combine_pdt"
#####################################################################################
