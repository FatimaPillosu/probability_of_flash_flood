...
##################################################################################################################
# CODE DESCRIPTION
# retrieve_reanalysis_era5_ecpoint_tp_fc_24h.sh retrieves from disk the 24-hourly medium-range rainfall forecasts from ERA5-ecPoint.  
...
dir_out="data/raw/reanalysis/era5_ecpoint/tp_fc_24h"
##################################################################################################################
