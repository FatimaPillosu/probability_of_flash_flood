...
#######################################################
# CODE DESCRIPTION
# retrieve_reanalysis_era5_swvl.sh retrieves from MARS the 
# volumetric soil water from ERA5 (31 km resolution) for the first 3 
# soil levels.
...
dir_out="data/raw/reanalysis/era5/swvl"
#######################################################
