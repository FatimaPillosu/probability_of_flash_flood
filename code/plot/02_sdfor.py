...
############################################################################################################
# CODE DESCRIPTION
# 02_sdfor.py plots the standard deviation of the filtered sub-gridscale orography from ERA5 (at 31 km resolution).

# Usage: python3 02_sdfor.py
