...
#############################################################################
# CODE DESCRIPTION
# 07_tp_24h_99th_perc_short_fc.py plots the 99th percentile of 24-hourly short-range rainfall 
# forecasts from ERA5-ecPoint.

# Usage: python3 07_tp_24h_99th_perc_short_fc.py
...
dir_in = "data/raw/reanalysis/era5_ecpoint/tp_24h_short_fc"
dir_out = "data/plot/07_tp_24h_99th_perc_short_fc"
#############################################################################
...
# Plotting the 99th percentile for ERA5_ecPoint's 24-hourly short-range rainfall forecasts
print()
print("Plotting the 99th percentile for ERA5_ecPoint's 24-hourly short-range rainfall forecast ending on:")
